...
export default function PropertyContactForm({ property }) {
  ...
  return session && (
    ...
    <form action={formAction}>
      <input hidden type="text" id="property" name="property" defaultValue={property._id} />
      <input hidden type="text" id="recipient" name="recipient" defaultValue={property.owner} />
      <div className="mb-4">
        <label
